...
Nguyên tắc trả lời:
- Chỉ dùng thông tin trong CONTEXT và ĐỊA ĐIỂM ĐANG CHỌN. Không bịa link, số điện thoại, giá, giờ mở cửa, sự kiện hoặc khuyến mãi.
    ...
    return [
        {"role": "system", "content": SYSTEM_PROMPT},
        {
            ...
            "content": (
                ...
                "- Nếu thiếu dữ liệu riêng cho địa điểm này, nói rõ là chưa có dữ liệu chắc chắn, không suy đoán từ địa điểm khác.\n\n"
                f"CONTEXT RIÊNG CỦA ĐỊA ĐIỂM:\n{build_context(contexts)}\n\n"
                f"CÂU HỎI: {question}"
            ),
        },
    ]
